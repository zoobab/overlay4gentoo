...
DESCRIPTION="Restund is a modular and flexible STUN and TURN Server, with IPv4 and IPv6 support"
...
# Portage.
SRC_URI="http://www.creytiv.com/pub/restund-0.4.0.tar.gz"
